package ir.notopia.android.scanner.liveedgedetection.util;
...
public class ScanUtils {
    ...
    public static String[] saveToExternalStorage(Bitmap bitmap, String mFileDirectory, String
            mFileName, Context mContext, int mQuality) {

        String[] mReturnParams = new String[2];
//        File mDirectory = getBaseDirectoryFromPathString(mFileDirectory, mContext);
        File mDirectory = new File(Environment.getExternalStorageDirectory().toString() + "/Dastyar/" + mFileDirectory);
    ...
    public static File createImageFile(String name) throws IOException {
        ...
        File storageDir = new File(Environment.getExternalStorageDirectory().toString() + "/Dastyar/Debug");
        if (!storageDir.exists()) {
            storageDir.mkdirs();
        }
//        File storageDir = getExternalFilesDir(Environment.DIRECTORY_PICTURES);

        File image = new File(storageDir, name + ".png");
